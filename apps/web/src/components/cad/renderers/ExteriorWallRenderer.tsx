  ...
  return (
    <group>
      <mesh position={[x, height / 2, z]}>
        ...
        <meshStandardMaterial color="#cdba97" roughness={0.85} metalness={0.02} transparent opacity={0.88} />
      </mesh>
...
export default function ExteriorWallRenderer({
  ...
  return (
    <group>
      ...
      {!footprint.hideWalls && Array.from({ length: Math.max(0, footprint.stories - 1) }).map((_, floor) => (
